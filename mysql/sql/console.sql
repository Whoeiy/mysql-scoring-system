...
insert into extra_name values(11,'me_mns','1','卫生差','1','0');
insert into extra_name values(12,'me_mns','2','无故晚归','0.5','0');
insert into extra_name values(13,'pe_etr','1','校级以上运动会','2','0');
insert into extra_name values(14,'pe_etr','2','校级运动会','1','0');
insert into extra_name values(15,'pe_etr','3','学校体育比赛','2','0');
insert into extra_name values(16,'pe_etr','4','趣味运动会','1','0');
insert into extra_name values(17,'ie_etr','1','发表学术论文','5','0');
insert into extra_name values(18,'ie_etr','2','学术/学科竞赛','5','0');
insert into extra_name values(19,'ie_etr','3','暑期社会实践','1.5','0');

select extra, detail, name from extra_name order by extra, detail;
select distinct extra from extra_name order by extra;
select detail,name from extra_name where extra = 'me_etr' order by cast(detail as signed);
select cast(detail as signed) from extra_name;

select name from extra_name where extra = 'me_etr' order by cast(detail as signed);

select * from student;

drop procedure proc_get_extra_detail_name;
delete from extra_name;
...
select * from extra_name;


# 11.10.1
# student_test_operation
select * from student;
delete from student;
...
# extra_test_operation

select * from extra;
alter table extra auto_increment = 1;
...
select *from extra where s_no = '170101008' and extra = 'me_etr' and status = '1' and pass = '1';
...
describe moral;
ALTER TABLE  moral MODIFY year char(10);