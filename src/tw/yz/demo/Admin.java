...
//				Standard();
	...
	public static void Student() {
		...
		System.out.println("\t  4. \t查询学生信息(未启用)");
...
//				searchStudent();
	...
	public static  void addStudent(){
		...
		System.out.println("\t* 请按照格式输入学生信息: ");
		System.out.println("\t* e.g.: 180501002,林一,1805,10501,团支书");
	...
	public static void updateStudent(){
		...
		System.out.println("\t* 请按照格式输入要修改学生的学号，修改项目编号和内容: ");
		System.out.println("\t  2. \t修改姓名");
		System.out.println("\t  3. \t修改班级号");
		System.out.println("\t  4. \t修改专业号");
		System.out.println("\t  5. \t修改属性");
		System.out.println("\t* e.g.: 180501002,1805,3");
		System.out.print("\t* 请输入: ");
		Scanner in =  new Scanner(System.in);
		String str = in.next();
